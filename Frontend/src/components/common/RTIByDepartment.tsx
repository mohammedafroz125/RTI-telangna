...
// 6 categories for the redesigned multi-column layout
const departmentCategories = [
  ...
  {
    category: 'Social Welfare & Others',
    items: [
      'RTI Telangana Social Welfare Department',
      'RTI Telangana Scheduled Castes Development Department',
      'RTI Telangana Scheduled Tribes Welfare Department',
  ...
  {
    category: 'Transport & Urban Services',
    items: [
      'RTI Telangana Transport Department',
      'RTI Telangana Information Technology Department',
      'RTI Telangana State Technology Services (TSTS)',
...
const RTIByDepartmentComponent: React.FC = () => {
  return (
    <section className="bg-white py-12" aria-label="RTI Services by Telangana Department">
                  ...
                  {column.items.map((item, itemIndex) => (
                    <li key={itemIndex}>
                      <Link
                        ...
                        className="text-xs leading-tight text-gray-700 hover:text-primary-600 cursor-pointer transition-colors duration-150 block"
